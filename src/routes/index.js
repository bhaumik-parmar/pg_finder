...
import AuthGuard, { AdminGuard, UserGuard } from '../guards/AuthGuard';
...
export default function Router() {
  ...
  return useRoutes([
    ...
    // Dashboard Routes
    {
      path: 'dashboard/pg-finder/Admin',
      element: (
        <AdminGuard>
          <DashboardLayout />
        </AdminGuard>
      ...
      children: [
        { element: <Navigate to="/dashboard/pg-finder/Admin/app" replace /> },
    ...
    {
      path: 'dashboard/pg-finder/customer',
      element: (
        <UserGuard>
          <DashboardLayout />
        </UserGuard>
      ...
      children: [
        {
          element: <Navigate to="/dashboard/pg-finder/customer/home" replace />
        },
    ...
    //   path: 'pg-finder',
    //   children: [
    //     // { element: <Navigate to="/dashboard/pg-finder/home" replace /> },
    //   ]
    // },
    // {
    //   path: 'user',
