...
//
import { sidebarConfigCustomer, sidebarConfigAdmin } from './SidebarConfig';
...
export default function DashboardSidebar({ isOpenSidebar, onCloseSidebar }) {
  ...
  const renderContent = (
    ...
    >
      ...
      <NavSection navConfig={data === 'customer' ? sidebarConfigCustomer : sidebarConfigAdmin} isShow={!isCollapse} />
      <Box sx={{ flexGrow: 1 }} />
      {/* {!isCollapse && (
